  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <button className="flex text-black items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium">
          <svg
            className="w-4 h-4"
            fill="none"
            stroke="currentColor"
      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div className="bg-gray-50 border-b border-gray-200">
          <div className="grid grid-cols-12 gap-4 px-6 py-3">
            ...
            <div className="col-span-1 text-xs font-medium text-gray-600 uppercase tracking-wider text-right">
              Actions
            </div>
          </div>
        </div>
        ...
        <div className="divide-y divide-gray-200">
          {jobWalks.map((job) => (
            ...
            >
              <div className="col-span-2 text-sm text-gray-900">{job.date}</div>
              ...
              <div className="col-span-2 text-sm text-gray-600">{job.user}</div>
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <select className="w-full px-3 py-2 border border-gray-300 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-blue-500">
                  <option>All</option>
            ...
            {completedTasks.map((task) => (
              <div key={task.id} className="px-6 py-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="text-sm text-gray-600 line-through">
                      {task.title}
                    </h3>
