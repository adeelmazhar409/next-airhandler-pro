...
export default function JobWalksAndTasks() {
  ...
  return (
    <div className="bg-platinum/10">
      ...
      {/* Content Area */}
      <div className="p-6">
        {activeTab === "jobWalks" && <JobWalksContent />}
...
function Admin() {
  ...
  return (
    <main className=" border p-6 mx-4 border-slate/60 rounded-lg">
      <section className=" mx-auto">
        ...
        <div className="space-y-4">
          {/* Single Task Card */}
          <div className="flex items-center justify-between p-6 border border-gray-300 rounded-lg bg-white hover:shadow-md transition-shadow">
            <div>
              <h3 className="text-lg font-medium text-gray-900">Task Title</h3>
              <p className="text-sm text-gray-500 mt-1">
                Completed by timwalick@gmail.com on November 17th, 2025
              </p>
            </div>

            {/* shadcn/ui Button (recommended) */}
            <button className="bg-cerulean p-2 rounded-lg">view</button>
          </div>

          {/* Add more task cards here if needed in the future */}
        </div>
        <div className="bg-white border my-6 border-silver rounded-lg">
          {/* Header */}
          <div className="px-6 py-4 border-b border-silver">
            <h2 className="text-base font-semibold text-charcoal">
